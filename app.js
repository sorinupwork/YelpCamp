...
mongoose.connect("mongodb+srv://sorin:sorin@yelpcamp-wvdo2.mongodb.net/test?retryWrites=true&w=majority")
...
app.listen(port|| process.env.PORT, process.env.IP, function(){
  console.log("YelpCamp Served has Started!")
})
